...
export const Header: React.FC<HeaderProps> = ({ onOpenSettings }) => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-obsidian-900/90 backdrop-blur-md border-b border-obsidian-700">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="hidden md:flex flex-col flex-1 max-w-xs mx-4">
          ...
          <div className="w-full h-2 bg-obsidian-800 rounded-full overflow-hidden border border-obsidian-600">
            <div
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          {/* Streak Freeze Badge */}
          <div
            className="flex items-center gap-1 px-2 py-1 rounded-lg bg-obsidian-800 border border-obsidian-600 text-xs font-medium text-zinc-300"
          ...
          <button
            ...
            className={`p-1.5 sm:p-2 rounded-lg bg-obsidian-800 border border-obsidian-600 text-zinc-400 hover:text-white transition-all ${
          ...
          <button
            ...
            className="p-1.5 sm:p-2 rounded-lg bg-obsidian-800 border border-obsidian-600 text-zinc-400 hover:text-white transition-colors"
            title="Settings"
          >
      ...
      <div className="md:hidden w-full h-1 bg-obsidian-800 overflow-hidden">
        <div
